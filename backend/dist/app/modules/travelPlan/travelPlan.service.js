...
const updateTravelPlan = (_a) => __awaiter(void 0, [_a], void 0, function* ({ userId, planId, payload, }) {
    const plan = yield prisma_1.default.travelPlan.findUnique({ where: { id: planId } });
    if (!plan) {
        throw new appError_1.default(http_status_1.default.NOT_FOUND, "Travel plan not found");
    }
    ...
    return yield prisma_1.default.travelPlan.update({
        where: { id: planId },
        data: payload,
    });
});
const deleteTravelPlan = (user, planId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        yield tx.review.deleteMany({ where: { travelPlanId: planId } });
        yield tx.matchRequest.deleteMany({ where: { travelPlanId: planId } });
        return yield tx.travelPlan.delete({ where: { id: planId } });
    }));
});
const getFeedTravelPlans = (userId, options, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (minBudget)
        whereConditions.minBudget = { gte: Number(minBudget) };
    if (maxBudget)
        whereConditions.maxBudget = { lte: Number(maxBudget) };
    if (travelType)
